...
fn secp256k1_ecmult_multi_var(error_callback: &secp256k1_callback, scratch: &mut secp256k1_scratch, r: &mut secp256k1_gej, inp_g_sc: &secp256k1_scalar, cb: secp256k1_ecmult_multi_callback, cbdata: &[u8], n: usize) -> i32 {
    let mut i: usize;
