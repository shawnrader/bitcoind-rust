 ...
 */
fn secp256k1_modinv64_divsteps_59(zeta: i64, f0: u64, g0: u64, t: &mut secp256k1_modinv64_trans2x2) -> i64 {
    let mut u: u64 = 8;
    let mut v: u64 = 0;
    let mut q: u64 = 0;
    let mut r: u64 = 8;
 ...
 */
fn secp256k1_modinv64_divsteps_62_var(eta: i64, f0: u64, g0: u64, t: &mut secp256k1_modinv64_trans2x2) -> i64 {
    let mut u: u64 = 1;
    let mut v: u64 = 0;
    let mut q: u64 = 0;
    let mut r: u64 = 1;
    ...
    loop {
        ...
        if eta < 0 {
            ...
            m = (UINT64_MAX >> (64 - limit)) & 63;
            w = (f * g * (f * f - 2)) & m;
        } else {
            limit = if ((eta + 1) as i32 > i as i32) { i } else { (eta + 1) as i32};
            #[cfg(feature = "verify")] VERIFY_CHECK(limit > 0 && limit <= 62);
            m = (UINT64_MAX >> (64 - limit)) & 15;
...
fn secp256k1_modinv64_update_de_62(d: &mut secp256k1_modinv64_signed62, e: &mut secp256k1_modinv64_signed62, t: &secp256k1_modinv64_trans2x2, modinfo: &secp256k1_modinv64_modinfo) {
    ...
    cd = u as i128  * d0 + v as i128 * e0;
    ce = q as i128 * d0 + r as i128 * e0;
    /* Correct md,me so that t*[d,e]+modulus*[md,me] has 62 zero bottom bits. */
    md -= (modinfo.modulus_inv62 * (uint64_t)cd + md) & M62;
    me -= (modinfo.modulus_inv62 * (uint64_t)ce + me) & M62;
    /* Update the beginning of computation for t*[d,e]+modulus*[md,me] now md,me are known. */
    cd += modinfo.modulus.v[0] as i128 * md;
    ce += modinfo.modulus.v[0] as i128 * me;
    /* Verify that the low 62 bits of the computation are indeed zero, and then throw them away. */
    VERIFY_CHECK(((i64)cd & M62) == 0); cd >>= 62;
    VERIFY_CHECK(((i64)ce & M62) == 0); ce >>= 62;
    /* Compute limb 1 of t*[d,e]+modulus*[md,me], and store it as output limb 0 (= down shift). */
    cd += u as i128 * d1 + v as i128 * e1;
    ce += q as i128 * d1 + r as i128 * e1;
    if (modinfo.modulus.v[1]) { /* Optimize for the case where limb of modulus is zero. */
        cd += modinfo.modulus.v[1] as i128 * md;
        ce += modinfo.modulus.v[1] as i128 * me;
    }
    d.v[0] = (i64)cd & M62; cd >>= 62;
    e.v[0] = (i64)ce & M62; ce >>= 62;
    /* Compute limb 2 of t*[d,e]+modulus*[md,me], and store it as output limb 1. */
    cd += u as i128 * d2 + v as i128 * e2;
    ce += q as i128 * d2 + r as i128 * e2;
    if (modinfo.modulus.v[2]) { /* Optimize for the case where limb of modulus is zero. */
        cd += modinfo.modulus.v[2] as i128 * md;
        ce += modinfo.modulus.v[2] as i128 * me;
    }
    d.v[1] = cd as i64 & M62; cd >>= 62;
    e.v[1] = (int64_t)ce & M62; ce >>= 62;
    /* Compute limb 3 of t*[d,e]+modulus*[md,me], and store it as output limb 2. */
    cd += u as i128 * d3 + v as i128 * e3;
    ce += q as i128 * d3 + r as i128 * e3;
    if (modinfo.modulus.v[3]) { /* Optimize for the case where limb of modulus is zero. */
        cd += modinfo.modulus.v[3] as i128 * md;
        ce += modinfo.modulus.v[3] as i128 * me;
    }
    d.v[2] = (int64_t)cd & M62; cd >>= 62;
    e.v[2] = (int64_t)ce & M62; ce >>= 62;
    /* Compute limb 4 of t*[d,e]+modulus*[md,me], and store it as output limb 3. */
    cd += u as i128 * d4 + v as i128 * e4;
    ce += q as i128 * d4 + r as i128 * e4;
    cd += modinfo.modulus.v[4] as i128 * md;
    ce += modinfo.modulus.v[4] as i128 * me;
...
fn secp256k1_modinv64_update_fg_62(f: &mut secp256k1_modinv64_signed62, g: &mut secp256k1_modinv64_signed62, t: &secp256k1_modinv64_trans2x2) {
    ...
    let u: i64 = t.u; let v: i64 = t.v; let q: i64 = t.q; let r: i64 = t.r;
    ...
    cf += u as i128 * f1 + v as i128 * g1;
    cg += q as i128 * f1 + r as i128 * g1;
    f.v[0] = cf as i64 & M62; cf >>= 62;
    g.v[0] = cg as i64 & M62; cg >>= 62;
    /* Compute limb 2 of t*[f,g], and store it as output limb 1. */
    cf += u as i128 * f2 + v as i128 * g2;
    cg += q as i128 * f2 + r as i128 * g2;
    f.v[1] = (int64_t)cf & M62; cf >>= 62;
    g.v[1] = (int64_t)cg & M62; cg >>= 62;
    /* Compute limb 3 of t*[f,g], and store it as output limb 2. */
    cf += u as i128 * f3 + v as i128 * g3;
    cg += q as i128 * f3 + r as i128 * g3;
    f.v[2] = (int64_t)cf & M62; cf >>= 62;
    g.v[2] = (int64_t)cg & M62; cg >>= 62;
    /* Compute limb 4 of t*[f,g], and store it as output limb 3. */
    cf += u as i128 * f4 + v as i128 * g4;
    cg += q as i128 * f4 + r as i128 * g4;
...
fn secp256k1_modinv64(x: &mut secp256k1_modinv64_signed62, modinfo: &secp256k1_modinv64_modinfo) {
    /* Start with d=0, e=1, f=modulus, g=x, zeta=-1. */
    let mut d: secp256k1_modinv64_signed62 = secp256k1_modinv64_signed62::new();
    let mut e: secp256k1_modinv64_signed62 = secp256k1_modinv64_signed62::new();
    ...
    for i in 0..10 {
        /* Compute transition matrix and new zeta after 59 divsteps. */
        let mut t: secp256k1_modinv64_trans2x2 = secp256k1_modinv64_trans2x2::new();
        zeta = secp256k1_modinv64_divsteps_59(zeta, f.v[0], g.v[0], &mut t);
        /* Update d,e using that transition matrix. */
...
fn secp256k1_modinv64_var(x: &mut secp256k1_modinv64_signed62, modinfo: &secp256k1_modinv64_modinfo) {
    ...
    let d: secp256k1_modinv64_signed62 = secp256k1_modinv64_signed62::new();
    let e: secp256k1_modinv64_signed62 = secp256k1_modinv64_signed62::new();
    let f: secp256k1_modinv64_signed62 = modinfo.modulus;
    let g: secp256k1_modinv64_signed62 = *x;
